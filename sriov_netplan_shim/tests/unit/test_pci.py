...
from sriov_netplan_shim.tests.unit.test_utils import CharmTestCase
from sriov_netplan_shim.tests.unit.test_utils import patch_open

from sriov_netplan_shim.tests.unit.test_pci_helper import check_device
...
class PCINetDeviceTest(CharmTestCase):
    ...
    @patch("os.path.islink")
    @patch("os.path.realpath")
    @patch("sriov_netplan_shim.pci.is_sriov")
    @patch("sriov_netplan_shim.pci.get_sysnet_device_state")
    @patch("sriov_netplan_shim.pci.get_sysnet_mac")
    @patch("sriov_netplan_shim.pci.get_sysnet_interface")
    @patch("sriov_netplan_shim.pci.PCINetDevice.update_attributes")
    ...
    @patch("sriov_netplan_shim.pci.PCINetDevice._set_sriov_numvfs")
